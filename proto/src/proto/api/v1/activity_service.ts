...
export const ActivityMemoCommentPayload: MessageFns<ActivityMemoCommentPayload> = {
  ...
  fromJSON(object: any): ActivityMemoCommentPayload {
    return {
      memoId: isSet(object.memoId) ? globalThis.Number(object.memoId) : 0,
      relatedMemoId: isSet(object.relatedMemoId) ? globalThis.Number(object.relatedMemoId) : 0,
    };
  },
  ...
  toJSON(message: ActivityMemoCommentPayload): unknown {
    const obj: any = {};
    if (message.memoId !== 0) {
      obj.memoId = Math.round(message.memoId);
    }
    if (message.relatedMemoId !== 0) {
      obj.relatedMemoId = Math.round(message.relatedMemoId);
    }
    return obj;
  },
...
export const ActivityVersionUpdatePayload: MessageFns<ActivityVersionUpdatePayload> = {
  encode(message: ActivityVersionUpdatePayload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.version !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ActivityVersionUpdatePayload {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ActivityVersionUpdatePayload {
    return { version: isSet(object.version) ? globalThis.String(object.version) : "" };
  },

  toJSON(message: ActivityVersionUpdatePayload): unknown {
    const obj: any = {};
    if (message.version !== "") {
